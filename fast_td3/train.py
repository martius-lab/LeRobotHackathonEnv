...
def main():
    ...
    def render_with_rollout():
        ...
        elif env_type in ["isaaclab", "mtbench", "lerobot"]:
            raise NotImplementedError(
                "Rendering is not supported for IsaacLab, MTBench, or LeRobot environments"
            )
        else:
            obs = render_env.reset()
            ...
            if global_step % 100 == 0 and start_time is not None:
                ...
                with torch.no_grad():
                    ...
                    if (
                        ...
                        if env_type == "lerobot":
                            print(
                                "Skipping rendering for LeRobot* envs: "
                                "PufferLib vectorization does not support rgb_array rollouts."
                            )
                        else:
